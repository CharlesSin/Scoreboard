    ...
    <footer className={classes.footer} data-cy="footer">
      <ul>
        <li className={classes.footerLinks}>
          <a href="https://twitter.com/CharlesSinCY" target="_blank" rel="noopener noreferrer" data-cy="twitterLink">
            twitter
          </a>{" "}
          &bull;{" "}
          <a href="https://github.com/CharlesSin" target="_blank" rel="noopener noreferrer" data-cy="githubLink">
            github
          </a>
        </li>
